          ...
          {!isMobile && (
            <>
              <FadeInSection delay={0.8}>
                <button
                  className="mt-4 px-6 py-2 bg-zinc-900 text-white rounded-lg shadow-lg border border-zinc-700 hover:bg-[#222222] hover:scale-105 active:scale-95 transition-all duration-150 font-semibold tracking-wide text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
